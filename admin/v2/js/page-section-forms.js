...
(function (global) {
  ...
  const PAGE_META = {
    about: {
      label: 'เกี่ยวกับเรา',
      hint: 'ส่วนโปรไฟล์ตัวแทนคนที่ 2 ยังแก้ใน HTML โดยตรง (รอบถัดไป)',
    },
    insurance: {
      label: 'แบบประกัน',
  ...
  global.PageSectionForms = {
    ...
    mergeConfig,
    formHtml(pageKey, sectionKey, config) {
      const c = mergeConfig(pageKey, sectionKey, config);
